...
public static class AccountsServiceLogs
{
    ...
    public const string CompleteAccount = "A new account has been created with ID: {id}";
    public const string BlockAccount = "Blocking all the lead's accounts";
    public const string GetAccountById = "Calling the repository method \"To get the account with ID {id}\"";
